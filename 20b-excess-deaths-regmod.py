...
### This script was adapted from 02b_fit_regmod_model.py in IHME's GitHub repository (https://github.com/ihmeuw-demographics/publication_covid_em), 
###  in order to perform the four base models which rely on regmod.
...
# note: use 17 knots across period to strike a balance between 3 knots * 6 years = 18 knots 
# and 3 * 5 years= 15 knots to have ref and pred periods have the same number of knots
def get_time_knots_adj(df, tail_size, num_knots=17):
...
# note: The IHME's function for knots was not operational at the time of this report, 
#       when using reference and prediction periods of difference sizes.
